...
const IMG_EXT  = ".webp"; // compressed WebP versions (~100KB each vs ~3MB PNG)

const TAROT_DECK = [
  { name: "Death",          img: IMG_BASE + "death.webp",
  ...
  { name: "Life",           img: IMG_BASE + "life.webp",
  ...
  { name: "Destruction",    img: IMG_BASE + "destruction.webp",
  ...
  { name: "Creation",       img: IMG_BASE + "creation.webp",
  ...
  { name: "Abundance",      img: IMG_BASE + "abundance.webp",
  ...
  { name: "Scarcity",       img: IMG_BASE + "scarcity.webp",
  ...
  { name: "Nourishment",    img: IMG_BASE + "nourishment.webp",
  ...
  { name: "Famine",         img: IMG_BASE + "famine.webp",
  ...
  { name: "Fortitude",      img: IMG_BASE + "fortitude.webp",
  ...
  { name: "Frailty",        img: IMG_BASE + "frailty.webp",
  ...
  { name: "The Sun",        img: IMG_BASE + "the_sun.webp",
  ...
  { name: "The Moon",       img: IMG_BASE + "the_moon.webp",
  ...
  { name: "The Stars",      img: IMG_BASE + "the_stars.webp",
  ...
  { name: "The Castle",     img: IMG_BASE + "the_castle.webp",
  ...
  { name: "Fire",           img: IMG_BASE + "fire.webp",
  ...
  { name: "Ice",            img: IMG_BASE + "ice.webp",
  ...
  { name: "Water",          img: IMG_BASE + "water.webp",
  ...
  { name: "Air",            img: IMG_BASE + "air.webp",
  ...
  { name: "Earth",          img: IMG_BASE + "earth.webp",
  ...
  { name: "The Emperor",    img: IMG_BASE + "the_emperor.webp",
  ...
  { name: "The Empress",    img: IMG_BASE + "the_empress.webp",
  ...
  { name: "The Wizard",     img: IMG_BASE + "the_wizard.webp",
  ...
  { name: "The Witch",      img: IMG_BASE + "the_witch.webp",
  ...
  { name: "The Knight",     img: IMG_BASE + "the_knight.webp",
  ...
  { name: "The Jester",     img: IMG_BASE + "the_jester.webp",
  ...
  { name: "The Dragon",     img: IMG_BASE + "the_dragon.webp",
  ...
  { name: "The Sword",      img: IMG_BASE + "the_sword.webp",
  ...
  { name: "The Staff",      img: IMG_BASE + "the_staff.webp",
  ...
  { name: "The Unknown",    img: IMG_BASE + "the_unknown.webp",
  ...
  { name: "The Deity",      img: IMG_BASE + "the_deity.webp",
  ...
  { name: "The Wolf",       img: IMG_BASE + "the_wolf.webp",
  ...
  { name: "The Snake",      img: IMG_BASE + "the_snake.webp",
  ...
  { name: "The Hawk",       img: IMG_BASE + "the_hawk.webp",
  ...
  { name: "The Mountain",   img: IMG_BASE + "the_mountain.webp",
  ...
  { name: "Time",           img: IMG_BASE + "time.webp",
